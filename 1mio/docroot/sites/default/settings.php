 ...
 * @endcode
 */
$settings['hash_salt'] = 'kAa7E9jOS3lkYLGjyHJbO960kJIIwRl1bqcwHKxJyqlz5SUmlRlJDtoBV8C3VzUFelwPDGnWLA';
...
/**
 * Disabling (putting a high number) core flood control so Login Security
 * module can take the control of it.
 */
$config['user.flood']['user_limit'] = 50;
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/onemio/onemio-settings.inc';
}
