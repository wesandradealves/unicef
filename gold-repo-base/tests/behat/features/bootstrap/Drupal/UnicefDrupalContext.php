...
class UnicefDrupalContext extends RawDrupalContext implements SnippetAcceptingContext {
  ...
  public function __construct() {
    ...
    $this->aliasStorage = \Drupal::service('path_alias.repository');
  ...
  public function cleanEntities() {
    foreach ($this->entities as $entity_type => $entities) {
      ...
      foreach ($entities as $entity) {
        ...
        // If the entity doesn't have a canonical url
  ...
  /**
   * Creates and authenticates a user with the username, mail and password.
   *
   * @Given I am logged in as a user with name :name, email :email and password :password
   */
  public function assertAuthenticatedByUsernameAndPassword($name, $mail, $password) {
    $user = (object) [
      'name' => $name,
      'mail' => $mail,
      'pass' => $password,
   ...
   *
   * @Given There is a user with name :name, email :email and password :password
   */
  public function assertHaveUsernameAndPassword($name, $mail, $password) {
    $user = (object) [
      'name' => $name,
      'mail' => $mail,
      'pass' => $password,
